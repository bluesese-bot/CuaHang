...
namespace CuaHang.Presentation
{
    public partial class fr_NhanVien : Form
    {
        ...
        public void khoitaoluoi()
        {
            ...
            msds.Columns[3].HeaderText = "Địa Chỉ";
            msds.Columns[3].Width = 100;
            msds.Columns[4].HeaderText = "SĐT";
        ...
        private void msds_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtNs.Text = msds.Rows[dong].Cells[2].Value.ToString();
            txtdc.Text = msds.Rows[dong].Cells[3].Value.ToString();
